...
public class Item {
    ...
    public Item(String Item_Name, double Price, int quantity,String Allegens, String Desription,String info) {
        this.Item_Name = Item_Name;
        this.Price = Price;
        this.Allegens = Allegens;
        this.Desription = Desription;
    ...
    public String toString() {
        return "Item{" + "Item_Id=" + Item_Id + ", ItemDiscount_Id=" + ItemDiscount_Id + ", Category_Id=" + Category_Id + ", Recipe_Id=" + Recipe_Id + ", Item_Name=" + Item_Name + ", Price=" + Price + ", Allegens=" + Allegens + ", Desription=" + Desription + ", info=" + info + ", Quantity=" + Quantity + '}';
    }
}
