...
public class AdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RegisterService adminServ = new RegisterImpl();
        List<Customer>allCustomers = new ArrayList<>();
            if (request.getParameter("All_Customers") != null) {
                allCustomers=adminServ.readCustomer();
                request.setAttribute("customers", allCustomers.toString());
