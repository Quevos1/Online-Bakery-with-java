...
import co.za.mecer.service.CustomerServiceImplemet;
...
public class deleteServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CustomerService service = new CustomerServiceImplemet();
        
            int id = Integer.parseInt(request.getParameter("edtDelete"));
         ...
         int id2 = Integer.parseInt(request.getParameter("Delete"));
