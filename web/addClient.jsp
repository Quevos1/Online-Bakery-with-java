...
<html>
    ...
    <body>
        ...
        <form method="post" action="Admin_Add_Clients"style="max-width:500px;margin:auto">
            ...
            <button type="submit" class="btn" name="register_btn" value="Register">Add Client</button>
            <br>
