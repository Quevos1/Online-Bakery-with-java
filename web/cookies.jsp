<%-- 
    Document   : cookies
    Created on : 02 Nov 2022, 11:10:51 AM
    Author     : TRAIN 11
--%>
...
.dropdown:hover .dropdown-content {
  ...
  <a href="aboutUs.jsp"><i class="fa fa-fw fa-envelope"></i> Contact</a>
   <a href="login.jsp"><i class="fa fa-shopping-cart"></i> Cart</a>
        ...
        <% 
            ResultSet rs = DBConnection.getInstance().createStatement().executeQuery("SELECT * FROM muffins");
            while(rs.next()){
  ...
  <a target="_blank">
      ...
      <a href="cakes_jsp/<%=rs.getString(2)+".jsp"%>"><img src="muffinz//<%=rs.getString("Name")+".jpg"%>" width="600" height="400"></a>
  </a>
